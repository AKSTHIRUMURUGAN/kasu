...
const kasuDeviceSchema = new mongoose.Schema({
  ...
  status: { 
    type: String, 
    enum: ['unassigned', 'assigned', 'active', 'inactive', 'deactivated'], 
    default: 'unassigned' 
  },
  lastSync: { type: Date },
...
// Device Reassignment Request Schema
const deviceReassignmentRequestSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true },
  phone: { type: String, required: true },
  currentDeviceMac: { type: String }, // User's current device (if any)
  requestedDeviceMac: { type: String, required: true }, // Device they want to assign
...
const DeviceReassignmentRequest = mongoose.models.DeviceReassignmentRequest || mongoose.model('DeviceReassignmentRequest', deviceReassignmentRequestSchema)

export default User
export { Transaction, KasuDevice, Admin, DeviceReassignmentRequest }